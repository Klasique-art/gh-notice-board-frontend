...
interface OpportunityDetailCommentsProps {
    opportunityId: string;
}

const OpportunityDetailComments = ({
    opportunityId,
}: OpportunityDetailCommentsProps) => {
    ...
    const [comments, setComments] = useState<Comment[]>([
        {
            ...
            content:
                "Great opportunity! I applied last week and got a response within 3 days. The team is very professional.",
            likes: 12,
        ...
        },
        {
            id: "2",
            user: {
                username: "kwabena_dev",
                display_name: "Kwabena Mensah ✓",
                avatar: "https://i.pravatar.cc/100?img=15",
                is_verified: true,
            },
            content:
                "Does anyone know if they accept applications from candidates outside Accra?",
            likes: 5,
...
export default OpportunityDetailComments;
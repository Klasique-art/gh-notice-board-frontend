...
interface NewsDetailCommentsProps {
    articleId: string;
}

const NewsDetailComments = ({ articleId }: NewsDetailCommentsProps) => {
    ...
    const [comments, setComments] = useState<Comment[]>([
        {
            ...
            content: "Great article! This is exactly what Ghana needs right now. Looking forward to seeing how this develops.",
            likes: 24,
        ...
        },
        {
            ...
            user: {
                username: "kwaku_tech",
                display_name: "Kwaku Mensah",
                avatar: "https://i.pravatar.cc/100?img=12",
                is_verified: false,
            },
            content: "Thanks for sharing this insight. Would love to see more coverage on this topic from different perspectives.",
            likes: 12,

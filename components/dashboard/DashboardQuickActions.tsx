...
import { FileText, Calendar, Briefcase, Clock, Bookmark } from "lucide-react";
        ...
        <div className="bg-linear-to-r from-primary/5 via-secondary/5 to-accent/5 rounded-xl p-4 border-2 border-slate-200 mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                <Link
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-lg bg-white hover:bg-primary/5 border-2 border-slate-200 hover:border-primary transition-all duration-300 hover:scale-105 group"
                >
                ...
                <Link
                    ...
                    className="flex flex-col items-center gap-2 p-3 rounded-lg bg-white hover:bg-accent/5 border-2 border-slate-200 hover:border-accent transition-all duration-300 hover:scale-105 group"
                >
                    <div className="w-10 h-10 rounded-lg bg-accent/10 group-hover:bg-accent flex items-center justify-center transition-colors">
                        <Briefcase className="w-5 h-5 text-accent group-hover:text-white transition-colors" />
                    </div>
                    <span className="small-text font-semibold text-slate-700 text-center">
                        Post Job
                    </span>
                ...
                >
                    <div className="w-10 h-10 rounded-lg bg-slate-100 group-hover:bg-slate-200 flex items-center justify-center transition-colors">
                        <Clock className="w-5 h-5 text-slate-600 transition-colors" />
                    </div>
                    <span className="small-text font-semibold text-slate-700 text-center">
                        Submissions
                    </span>
